            ...
            v2f vert(appdata v)
            {
                ...
                float3 position = v.vertex.xyz;
                    ...
                    position = iigo_pants(position, o.audioLinkData.xy);
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                // =============================================================
                    ...
                    float emission = iigo_texture_EMISSION;
                        ...
                        emission *= iigo_hairEmission(iigo_hairEmission_TEXTURE, i.uv, iigo_hairEmission_EMISSION, i.basePos, i.iigo_audioLinkData_TIMEY);
